import {
  ...
  e,
  s
} from "./chunk-FWSLQ7Q2.js";
import "./chunk-76J2PTFD.js";

// node_modules/.pnpm/@tauri-apps+api@1.5.1/node_modules/@tauri-apps/api/chunk-J2IGCSS2.js
async function a(i) {
  return _("tauri", i);
}

// node_modules/.pnpm/@tauri-apps+api@1.5.1/node_modules/@tauri-apps/api/chunk-5NWA45Z3.js
var W = {};
...
async function m(n, t, r) {
  await a({ __tauriModule: "Event", message: { cmd: "emit", event: n, windowLabel: t, payload: r } });
}
async function a2(n, t, r) {
  return a({ __tauriModule: "Event", message: { cmd: "listen", event: n, windowLabel: t, handler: s(r) } }).then((i) => async () => s2(n, i));
}
